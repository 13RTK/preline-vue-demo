      ...
      >
        ...
        >
          <a
            ...
            :class="
              currentComponent === 'AppTable' ? activeClass : inactiveClass
            "
            href="#"
            aria-current="page"
            @click="changeComponent('AppTable')"
            >Home</a
          >
          <a
            class="font-medium focus:outline-none"
            :class="currentComponent === 'Info' ? activeClass : inactiveClass"
            href="#"
            @click="changeComponent('Info')"
            >Info</a
          >
        </div>
      </div>
...
<script setup>
defineProps(["changeComponent", "currentComponent"]);
